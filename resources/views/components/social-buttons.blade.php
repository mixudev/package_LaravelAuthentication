...
@if ($googleEnabled && $githubEnabled)
    {{-- Kedua tombol aktif: Ditampilkan bersebelahan 2 kolom (Kiri: Google, Kanan: GitHub) --}}
...
@elseif ($googleEnabled)
    ...
    <div class="w-full">
        <a 
            href="{{ $googleUrl }}" 
            class="auth-btn-secondary w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg border text-xs font-medium transition shadow-xs"
        >
            <svg class="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24">
                <path fill="#EA4335" d="M12 5c1.6 0 3 .6 4.1 1.7l3.1-3.1C17.3 1.8 14.8 1 12 1 7.5 1 3.7 3.6 1.9 7.3l3.7 2.9C6.5 7.3 9 5 12 5z"/>
                <path fill="#4285F4" d="M23.5 12.3c0-.8-.1-1.6-.2-2.3H12v4.5h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9c2.2-2 3.7-5 3.7-8.8z"/>
