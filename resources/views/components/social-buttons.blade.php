{{-- 
=============================================================================
KOMPONEN: TOMBOL SOCIAL AUTH (MODERN ZINC)
Package: mixudev/laravel-authentication
Deskripsi: Tombol login pihak ketiga bersih (Google & GitHub).
=============================================================================
--}}
@php
...
@if ($googleEnabled || $githubEnabled)
    <div class="space-y-2">
        <div class="grid grid-cols-1 sm:grid-cols-{{ ($googleEnabled && $githubEnabled) ? '2' : '1' }} gap-2.5">
            
            @if ($googleEnabled)
                <a 
                    href="{{ $googleUrl }}" 
                    class="flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 hover:bg-zinc-50 dark:hover:bg-zinc-900 text-zinc-800 dark:text-zinc-200 text-xs font-medium transition shadow-xs"
                >
