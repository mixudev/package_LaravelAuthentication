...
<title>Masuk Tanpa Kata Sandi (OTP) — Console</title>
...
<div class="wrap">
  ...
  <aside class="brand">
    <div class="brand-top">
      ...
      <span class="status-badge"><span class="dot"></span> Otentikasi Bebas Kata Sandi</span>

      <h1>Akses cepat dengan Kode OTP sekali pakai.</h1>
      <p>Masuk secara instan tanpa perlu mengingat kata sandi. Kami akan mengirimkan kode verifikasi 6-digit yang aman ke identifier Anda.</p>
    </div>
    ...
    <div>
      <div class="pulse-wrap">
        ...
        <div class="pulse-caption"><span>KODE SEKALI PAKAI</span><span>EXPIRES IN {{ config('authentication.features.otp.expiry_minutes', 10) }}M</span></div>
      </div>
  ...
  <main class="stage">
    <div class="card">
      <div class="card-head">
        ...
        <p>Masukkan alamat email atau nomor identitas akun Anda untuk menerima kode verifikasi.</p>
      </div>
      ...
      <form method="POST" action="{{ route('otp.send') }}">
        ...
        <div class="field">
          <label for="identifier">Email / Identifier</label>
          <div class="input-shell">
            <input type="text" id="identifier" name="identifier" value="{{ old('identifier') }}" placeholder="nama@email.com" autocomplete="username" required autofocus class="@error('identifier') is-invalid @enderror">
          </div>
          @error('identifier')
      ...
      <div class="back-row">
        Ingin masuk dengan kata sandi? <a href="{{ route('login') }}">Masuk biasa</a>
      </div>
    </div>
  </main>
...
<script>
  ...
  if (form && btnSubmit) {
    form.addEventListener('submit', () => {
      ...
      btnText.innerHTML = '<span class="spinner"></span> Mengirim OTP...';
    });
  }
</script>
